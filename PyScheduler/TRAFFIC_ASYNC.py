...
# - Новый experimental-модуль асинхронной генерации legacy traffic snapshots.
# - Реализован worker-owned SimpleGenerator для закреплённых UE и применение TrafficSnapshot в
#  main process.
# - По результатам профилирования модуль оставлен experimental/off by default из-за IPC
#  overhead при передаче миллионов Packet-объектов.
#------------------------------------------------------------------------------
"""
