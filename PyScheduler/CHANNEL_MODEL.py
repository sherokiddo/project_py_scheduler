...
class RMaModel(ChannelModel):
    ...
    def __init__(
        self, bs: BaseStation, W: float = 20.0, h: float = 5.0, cond_update_period: float = 0.0
    ):
        """
...
class UMaModel(ChannelModel):
    ...
    def __init__(self, bs: BaseStation, cond_update_period: float = 0.0, o2i_model: str = "low"):
        """
