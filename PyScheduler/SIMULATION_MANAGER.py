...
# Автор: Норицин Иван, Брагин Кирилл, Македон Никита
# Версия Python Kernel: 3.12.9
#
# v1.2.0 - 2026-06-07:
# Автор изменений: Македон Никита
# - Добавлены настройки и запуск async mobility, parallel channel и experimental async traffic.
# - Введён PhaseProfiler для замера фаз TTI, provider counters и итогового summary.
# - Добавлены настройки benchmark/export: отключение тяжёлого CSV/detailed export и duplicate
#  collect.
# - Добавлен runtime smoothing: пакетное обновление progressbar, реже status refresh,
#  управление cyclic GC.
# - Основной процесс оставлен single-writer для UE, buffers, scheduler и RES_GRID;
#  worker-процессы возвращают snapshots.
#------------------------------------------------------------------------------
"""
