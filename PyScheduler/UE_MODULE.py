...
# Автор: Брагин Кирилл, Норицин Иван, Дворников Андрей, Македон Никита
...
# - Добавлены методы применения MobilitySnapshot и ChannelSnapshot к живым UE в основном
#  процессе.
# - UECollection получила интеграцию с MobilityAsyncProvider и ChannelParallelProvider.
# - Фазы mobility/channel разделены барьером по step_idx, чтобы канал не считал по частично
#  обновлённой позиции UE.
#------------------------------------------------------------------------------
"""
