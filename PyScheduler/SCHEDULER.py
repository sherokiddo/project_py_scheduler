...
# Автор: Брагин Кирилл, Норицин Иван, Македон Никита
#
# Зависимости:
...
# - Добавлен alias FD_RR для совместимости документации, тестов и factory-registry.
# - Уточнён tie-break в frequency-domain PF-сценариях для более стабильного распределения RB
#  при равных метриках.
# - Сохранена single-writer архитектура: scheduler и RES_GRID остаются в основном процессе для
