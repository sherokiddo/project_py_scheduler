...
# Автор: Норицин Иван, Дворников Андрей, Македон Никита
...
# - Добавлен явный контракт export_worker_state()/import_worker_state() для восстановления
#  моделей мобильности в worker-процессах.
# - Исправлены пограничные случаи RandomDirectionModel, чтобы избежать бесконечного retry-loop
#  у границ карты.
# - Исправлен GaussMarkovModel: скорость ограничивается снизу нулём, направление нормализуется.
#------------------------------------------------------------------------------
"""
