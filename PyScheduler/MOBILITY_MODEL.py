...
#
# Версия: 1.0.1
# Дата последнего изменения: 2025-10-28
# Автор: Норицин Иван, Дворников Андрей
# Версия Python Kernel: 3.12.9
#
# Изменения в v.1.0.1:
# - Добавлена модель движения через соту DiagonalWalkModel.
#------------------------------------------------------------------------------
"""
...
class DiagonalWalkModel:
    ...
    Устройство движется в сторону базовой станции к противоположным координатам относительно БС.
    """
    def __init__(self, bs_x: float, bs_y: float, pause_time: int):
        """
        Инициализация модели движения DiagonalWalk.
    ...
    def _choose_new_destination(self, current_position: Tuple[float, float], 
                                ...
                                ) -> Tuple[Tuple[float, float], float, float, bool, float, float]:
        """
        Выбирает новую точку назначения, скорость и направление для устройства.
    ...
    def update(self, current_position: Tuple[float, float], 
