...
# - Packet переведён на dataclass(slots=True) для уменьшения overhead при миллионах объектов.
# - PoissonModel.generate_traffic() ускорен через генерацию количества пакетов из
#  Poisson(lambda * dt) и времён внутри TTI.
# - Сохранена совместимость SimpleGenerator/PacketManager с существующим SimulationManager.
#------------------------------------------------------------------------------
"""
