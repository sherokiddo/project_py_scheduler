...
def debug_simulation():
    ...
    random_waypoint = RandomWaypointModel(
        x_min=-1000, x_max=1000, y_min=-1000, y_max=1000, pause_time=0
    )
    ...
    # diagonal = DiagonalWalkModel(
    #     bs.position[0],
    #     bs.position[1]
    # )

    # ue1.SET_MOBILITY_MODEL(diagonal)
    # ue2.SET_MOBILITY_MODEL(diagonal)
    # ue3.SET_MOBILITY_MODEL(diagonal)
