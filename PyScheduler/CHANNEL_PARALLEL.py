...
# - Новый модуль параллельного batch-расчёта качества канала в worker-процессах.
# - Добавлены сериализуемые ChannelInput и immutable ChannelSnapshot.
# - UE закрепляются за worker по ue_id % workers, чтобы состояние модели канала не мигрировало
#  между процессами.
# - Добавлена обработка stale/out-of-order результатов через step_idx и pending-cache.
#------------------------------------------------------------------------------
"""
